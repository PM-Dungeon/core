...
public class DungeonAnimation {
    /** The set of textures that build the animation. */
    private final List<DungeonTexture> animationFrames;
     ...
     */
    public DungeonAnimation(List<DungeonTexture> animationFrames, int frameTime) {
     ...
     */
    public DungeonTexture getNextAnimationTexture() {
