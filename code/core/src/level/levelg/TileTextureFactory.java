...
*/
    ...
    private static boolean isFourWayCross(Point p, LevelElement[][] layout) {
        return (aboveIsWall(p, layout) && belowIsWall(p, layout) && leftIsWall(p, layout) && rightIsWall(p, layout));
    }

    private static boolean isThreeWayCrossUp(Point p, LevelElement[][] layout) {
        return (!belowIsWall(p, layout) && aboveIsWall(p, layout) && leftIsWall(p, layout) && rightIsWall(p, layout));
    }
    ...
    private static boolean isThreeWayCrossRight(Point p, LevelElement[][] layout) {
        return (belowIsWall(p, layout) && aboveIsWall(p, layout) && rightIsWall(p, layout) && !leftIsWall(p, layout));
    }
